...
As I stressed earlier, we want a future where intelligent systems can build and improve themselves. To get there, we have to start from first principles.

**What does it actually take to build intelligent systems that perform at a high level?**
